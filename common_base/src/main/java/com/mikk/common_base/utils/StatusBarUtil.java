...
public class StatusBarUtil {
    ...
    public static void setColor(Activity activity, @ColorInt int color, @IntRange(from = 0, to = 255) int statusBarAlpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            //此属性是设置状态栏透明，setStatusBarColor才能设置不同的颜色值
...
//            activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
            ...
            //设置自定义布局的paddingTop是一个状态栏的高度，给decorView添加statusBarView预留空间
    ...
    public static void setColorForSwipeBack(Activity activity, @ColorInt int color,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            setTransparentWithNoNavigation(activity);
        }
    }
     ...
     * 设置透明
     */
    private static void setTransparentWithNoNavigation(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            activity.getWindow().setStatusBarColor(Color.TRANSPARENT);
            activity.getWindow()
                    .getDecorView()
...
//            状态栏沉寂式
     ...
     */
    public static void setTransparentWithNoNavigation(Activity activity, boolean hideStatusBarBackground) {
...
//                window.getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
     ...
     * @param hideStatusBarBackground
     */
    public static void setTransparentWithNoNavigation(Activity activity, boolean hideStatusBarBackground, boolean blackText) {
        Window window = activity.getWindow();
        //21 5.0
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
